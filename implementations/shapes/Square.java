...
public final class Square implements Shape, Visitable {
    private Point leftUp, leftDown, rightUp, rightDown;
    private int sideLength, alphaContour, alphaFilling;
    ...
    private void createCorners() {
        leftDown = new Point(leftUp.getX(), leftUp.getY() + sideLength - 1);
        rightUp = new Point(leftUp.getX() + sideLength - 1, leftUp.getY());
        rightDown = new Point(rightUp.getX(), rightUp.getY() + sideLength - 1);
    }
    @Override
    public void draw() {
